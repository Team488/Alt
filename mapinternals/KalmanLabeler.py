...
class KalmanLabeler:
    ...
    def createDetection(self,detectionC : tuple[int,int],detectionType: DetectionType,detectionProb : float) -> MapDetection:
        ...
        return MapDetection.MapDetection(detectionC,detectionType,detectionProb,label)
