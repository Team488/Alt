"""
    ...
    All the methods in this class should do minimal processing, just take in the data core input sends after mapinternals has done all its magic, then spit it out back over the network
