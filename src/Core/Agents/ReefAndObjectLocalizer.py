...
class ReefAndObjectLocalizer(ObjectLocalizingAgentBase,ReefTrackingAgentBase):
    ...
    def __init__(self, cameraPath : str, showFrames : bool, cameraIntrinsics : CameraIntrinsics, cameraExtrinsics : CameraExtrinsics, inferenceMode : InferenceMode):
        super().__init__(
...
def ReefAndObjectLocalizerPartial(cameraPath : str, cameraIntrinsics : CameraIntrinsics, cameraExtrinsics : CameraExtrinsics, inferenceMode : InferenceMode, showFrames : bool = False):
    return partial(
