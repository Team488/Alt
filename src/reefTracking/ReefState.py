...
class ReefState:
    ...
    def dissipateOverTime(self, timeFactor : int):
        ...
        self.reef_map *= np.power(self.DISSIPATIONFACTOR, round(timeFactor/100)) # discrete dissipation
    ...
    def getClosestOpen(self, robotPos2CMRAd : tuple[float,float,float], team : TEAM = None, threshold = 0.5):
